...
write_to = "beenative/_version.py"
```
...
[project]
name = "beenative"
description = "An application to provide information about native plants."
authors = [{"name" = "Steven Elliott"}]
...
ls dist/
# beenative-1.2.3.tar.gz
# beenative-1.2.3-py3-none-any.whl
```
...
# Install from wheel
pip install dist/beenative-*.whl

# Verify installation
python -c "import beenative; print(beenative.__version__)"
...
1. Go to your project page: `https://pypi.org/project/beenative/`
...
```bash
# View on PyPI
open https://pypi.org/project/beenative/

# Install from PyPI
pip install beenative
