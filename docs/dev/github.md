...
- **Images**:
  - `ghcr.io/EXAMPLE/beenative.www` - FastAPI web server
...
python -c "from beenative._version import version; print(version)"
...
docker pull ghcr.io/EXAMPLE/beenative.www:main
...
services:
  www:
    image: ghcr.io/EXAMPLE/beenative.www:v1.2.3
```
