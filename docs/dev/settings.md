...
- **`beenative/conf/settings.py`**: Main Settings class
- **`beenative/conf/db.py`**: Database settings
- **`beenative/settings.py`**: Global settings instance
...
```python
from beenative.conf import settings
...
from beenative.conf.settings import Settings
...
```python
from beenative.conf.cache import CacheSettings
